                                    ...
                                    <div class=" col-lg-9">
                                        <div class="row">
                                            ...
                                            <div class="cil-sm-offset-4 col-sm-1">
                                                <a href='/topic/show?topicId=${recentShares?.topic?.id}'
                                                   class="anchor">${recentShares?.topic?.name}</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-offset-2 col-sm-4">
                                                <a href='/resource/show?resourceId=${recentShares?.id}'
                                                   class="anchor">View Post</a>
